...
content = [read_markdown_file(f"/Users/german/Documents/STADS/STADS-Python-Course/Project 9 Web-App Streamlit/Schedule Plan Python Course/assets/week_{i}.md") for i in range(1,9)]
